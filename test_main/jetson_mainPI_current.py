...
def main():
    ...
    parser.add_argument('--calibration-layers', type=int, default=5,
    ...
    while True:
        ...
        if last_layer is None:
            ...
            logger.info(f"old feed {old_feed}")
            ...
            if not control_active:
                ...
                if USE_CALIBRATION:
                    ...
                    logger.info(f"new feed {new_feed}")
                    ...
                    if len(durations) >= WARMUP_LAYERS:
                        ...
                        controller.calibrate_from_step_test(
                        ...
                        control_active = True
                        logger.info(f"Controller activated with predefined parameters: {predefined_cal}, also durations: {durations}. temps: {temps}")
                ...
                now = datetime.now().isoformat() #datetime.datetime.now().isoformat()
